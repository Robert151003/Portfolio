  ...
  return (
    <div>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className='mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]'>
        I am a skilled software developer with proficiency in a range of different languages and tools. Currently, I am exploring frameworks such as React, Node.js and Three.js.
