...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_qag2b8r', 
      'template_hjjartn',
      { from_name: form.name, 
        to_name: 'Robert', 
        from_email:form.email, 
        to_email: 'robert.forsythe1234@gmail.com', 
  ...
  return (
    <div
      className={`xl:mt-12 xl:ml-48 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden`}
    >
      <motion.div
      ...
      >
        ...
        {!isSmallScreen && 
          ...
          >
            {<EarthCanvas />} {/* Only render EarthCanvas on large screens */}
          </motion.div>
        }
    </div>
  );
